...
@section('title')
<title>Check Out DW-Commerce</title>
@endsection
        ...
        <div class="billing_details">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <!-- remove dulu value actionna jika ingin melihat tampilan dibrowser -->
                    <!-- karena route front.store_checkout belum dibuat -->
                    <form class="row contact_form" action="{{ route('front.store_checkout') }}" method="post"
                        novalidate="novalidate">
                        @csrf
                        <div class="col-md-12 form-group p_star">
                            <label for="">Nama Lengkap</label>
                            <input type="text" class="form-control" id="first" name="customer_name" required value="{{old('customer_name')}}">
                            <!-- untuk menampilkan misal terjadi error validasi -->
                            <p class="text-danger">{{$errors->first('customer_name')}}</p>
                        </div>
                        <div class="col-md-6 form-group p_star">
                            <label for="">No Telp</label>
                            <input type="text" class="form-control" id="number" name="customer_phone" required  value="{{old('customer_phone')}}">
                        ...
                        <div class="col-md-12 form-group p_star">
                            ...
                            <input type="text" class="form-control" id="add1" name="customer_address" required  value="{{old('customer_address')}}">
