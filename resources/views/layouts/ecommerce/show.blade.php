                ...
                <div class="s_product_text">
                    ...
                    <form action="{{ route('front.cart') }}" method="POST">
                        ...
                        <div class="product_count">
                            ...
                            <button
                                onclick="var result = document.getElementById('sst'); var sst = result.value; if( !isNaN( sst )) result.value++;  console.log(result.value); return false;"
                                class="increase items-count" type="button">
                                <i class="lnr lnr-chevron-up"></i>
                            </button>
                            <button
                                onclick="var result = document.getElementById('sst'); var sst = result.value; if( !isNaN( sst ) &amp;&amp; sst > 0 ) result.value--;  console.log(result.value); return false;"
