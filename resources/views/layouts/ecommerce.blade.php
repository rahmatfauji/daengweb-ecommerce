        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container-fluid">
                    ...
                    <!-- collect the navs links, forms, and other contents for toggleing -->
                    ...
                    <div id="mc_embed_signup">
                        <form target="_blank" novalidate
                            ...
                            <!-- <div style="position: absolute; left: -5000px;">
                                <input type="text" class name="b_36c4fd991d266f23781ded980_aefe40901a" tabindex="-1" value="">
                            </div> -->
